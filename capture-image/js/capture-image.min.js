 ...
 */
const directives=new WeakMap,isDirective=e=>"function"==typeof e&&directives.has(e),isCEPolyfill=void 0!==window.customElements&&void 0!==window.customElements.polyfillWrapFlushCallback,removeNodes=(e,t,s=null)=>{let i=t;for(;i!==s;){const t=i.nextSibling;e.removeChild(i),i=t}},noChange={},nothing={},marker=`{{lit-${String(Math.random()).slice(2)}}}`,nodeMarker=`\x3c!--${marker}--\x3e`,markerRegex=new RegExp(`${marker}|${nodeMarker}`),boundAttributeSuffix="$lit$";class Template{constructor(e,t){this.parts=[],this.element=t;let s=-1,i=0;const r=[],n=t=>{const a=t.content,o=document.createTreeWalker(a,133,null,!1);let l=0;for(;o.nextNode();){s++;const t=o.currentNode;if(1===t.nodeType){if(t.hasAttributes()){const r=t.attributes;let n=0;for(let e=0;e<r.length;e++)r[e].value.indexOf(marker)>=0&&n++;for(;n-- >0;){const r=e.strings[i],n=lastAttributeNameRegex.exec(r)[2],a=n.toLowerCase()+boundAttributeSuffix,o=t.getAttribute(a).split(markerRegex);this.parts.push({type:"attribute",index:s,name:n,strings:o}),t.removeAttribute(a),i+=o.length-1}}"TEMPLATE"===t.tagName&&n(t)}else if(3===t.nodeType){const e=t.data;if(e.indexOf(marker)>=0){const n=t.parentNode,a=e.split(markerRegex),o=a.length-1;for(let e=0;e<o;e++)n.insertBefore(""===a[e]?createMarker():document.createTextNode(a[e]),t),this.parts.push({type:"node",index:++s});""===a[o]?(n.insertBefore(createMarker(),t),r.push(t)):t.data=a[o],i+=o}}else if(8===t.nodeType)if(t.data===marker){const e=t.parentNode;null!==t.previousSibling&&s!==l||(s++,e.insertBefore(createMarker(),t)),l=s,this.parts.push({type:"node",index:s}),null===t.nextSibling?t.data="":(r.push(t),s--),i++}else{let e=-1;for(;-1!==(e=t.data.indexOf(marker,e+1));)this.parts.push({type:"node",index:-1})}}};n(t);for(const e of r)e.parentNode.removeChild(e)}}const isTemplatePartActive=e=>-1!==e.index,createMarker=()=>document.createComment(""),lastAttributeNameRegex=/([ \x09\x0a\x0c\x0d])([^\0-\x1F\x7F-\x9F \x09\x0a\x0c\x0d"'>=/]+)([ \x09\x0a\x0c\x0d]*=[ \x09\x0a\x0c\x0d]*(?:[^ \x09\x0a\x0c\x0d"'`<>=]*|"[^"]*|'[^']*))$/;
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * http://polymer.github.io/PATENTS.txt
 */
class TemplateInstance{constructor(e,t,s){this._parts=[],this.template=e,this.processor=t,this.options=s}update(e){let t=0;for(const s of this._parts)void 0!==s&&s.setValue(e[t]),t++;for(const e of this._parts)void 0!==e&&e.commit()}_clone(){const e=isCEPolyfill?this.template.element.content.cloneNode(!0):document.importNode(this.template.element.content,!0),t=this.template.parts;let s=0,i=0;const r=e=>{const n=document.createTreeWalker(e,133,null,!1);let a=n.nextNode();for(;s<t.length&&null!==a;){const e=t[s];if(isTemplatePartActive(e))if(i===e.index){if("node"===e.type){const e=this.processor.handleTextExpression(this.options);e.insertAfterNode(a.previousSibling),this._parts.push(e)}else this._parts.push(...this.processor.handleAttributeExpressions(a,e.name,e.strings,this.options));s++}else i++,"TEMPLATE"===a.nodeName&&r(a.content),a=n.nextNode();else this._parts.push(void 0),s++}};return r(e),isCEPolyfill&&(document.adoptNode(e),customElements.upgrade(e)),e}}
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */class TemplateResult{constructor(e,t,s,i){this.strings=e,this.values=t,this.type=s,this.processor=i}getHTML(){const e=this.strings.length-1;let t="";for(let s=0;s<e;s++){const e=this.strings[s],i=lastAttributeNameRegex.exec(e);t+=i?e.substr(0,i.index)+i[1]+i[2]+boundAttributeSuffix+i[3]+marker:e+nodeMarker}return t+this.strings[e]}getTemplateElement(){const e=document.createElement("template");return e.innerHTML=this.getHTML(),e}}
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */class DefaultTemplateProcessor{handleAttributeExpressions(e,t,s,i){const r=t[0];if("."===r){return new PropertyCommitter(e,t.slice(1),s).parts}return"@"===r?[new EventPart(e,t.slice(1),i.eventContext)]:"?"===r?[new BooleanAttributePart(e,t.slice(1),s)]:new AttributeCommitter(e,t,s).parts}handleTextExpression(e){return new NodePart(e)}}const defaultTemplateProcessor=new DefaultTemplateProcessor;
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */function templateFactory(e){let t=templateCaches.get(e.type);void 0===t&&(t={stringsArray:new WeakMap,keyString:new Map},templateCaches.set(e.type,t));let s=t.stringsArray.get(e.strings);if(void 0!==s)return s;const i=e.strings.join(marker);return void 0===(s=t.keyString.get(i))&&(s=new Template(e,e.getTemplateElement()),t.keyString.set(i,s)),t.stringsArray.set(e.strings,s),s}const templateCaches=new Map,parts=new WeakMap,render=(e,t,s)=>{let i=parts.get(t);void 0===i&&(removeNodes(t,t.firstChild),parts.set(t,i=new NodePart(Object.assign({templateFactory:templateFactory},s))),i.appendInto(t)),i.setValue(e),i.commit()};
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * http://polymer.github.io/PATENTS.txt
 */
(window.litHtmlVersions||(window.litHtmlVersions=[])).push("1.0.0");const html=(e,...t)=>new TemplateResult(e,t,"html",defaultTemplateProcessor),walkerNodeFilter=133;
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */function removeNodesFromTemplate(e,t){const{element:{content:s},parts:i}=e,r=document.createTreeWalker(s,walkerNodeFilter,null,!1);let n=nextActiveIndexInTemplateParts(i),a=i[n],o=-1,l=0;const h=[];let c=null;for(;r.nextNode();){o++;const e=r.currentNode;for(e.previousSibling===c&&(c=null),t.has(e)&&(h.push(e),null===c&&(c=e)),null!==c&&l++;void 0!==a&&a.index===o;)a.index=null!==c?-1:a.index-l,a=i[n=nextActiveIndexInTemplateParts(i,n)]}h.forEach(e=>e.parentNode.removeChild(e))}const countNodes=e=>{let t=11===e.nodeType?0:1;const s=document.createTreeWalker(e,walkerNodeFilter,null,!1);for(;s.nextNode();)t++;return t},nextActiveIndexInTemplateParts=(e,t=-1)=>{for(let s=t+1;s<e.length;s++){const t=e[s];if(isTemplatePartActive(t))return s}return-1};function insertNodeIntoTemplate(e,t,s=null){const{element:{content:i},parts:r}=e;if(null==s)return void i.appendChild(t);const n=document.createTreeWalker(i,walkerNodeFilter,null,!1);let a=nextActiveIndexInTemplateParts(r),o=0,l=-1;for(;n.nextNode();){for(l++,n.currentNode===s&&(o=countNodes(t),s.parentNode.insertBefore(t,s));-1!==a&&r[a].index===l;){if(o>0){for(;-1!==a;)r[a].index+=o,a=nextActiveIndexInTemplateParts(r,a);return}a=nextActiveIndexInTemplateParts(r,a)}}}
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */const getTemplateCacheKey=(e,t)=>`${e}--${t}`;let compatibleShadyCSSVersion=!0;void 0===window.ShadyCSS?compatibleShadyCSSVersion=!1:void 0===window.ShadyCSS.prepareTemplateDom&&(console.warn("Incompatible ShadyCSS version detected.Please update to at least @webcomponents/webcomponentsjs@2.0.2 and@webcomponents/shadycss@1.3.1."),compatibleShadyCSSVersion=!1);const shadyTemplateFactory=e=>t=>{const s=getTemplateCacheKey(t.type,e);let i=templateCaches.get(s);void 0===i&&(i={stringsArray:new WeakMap,keyString:new Map},templateCaches.set(s,i));let r=i.stringsArray.get(t.strings);if(void 0!==r)return r;const n=t.strings.join(marker);if(void 0===(r=i.keyString.get(n))){const s=t.getTemplateElement();compatibleShadyCSSVersion&&window.ShadyCSS.prepareTemplateDom(s,e),r=new Template(t,s),i.keyString.set(n,r)}return i.stringsArray.set(t.strings,r),r},TEMPLATE_TYPES=["html","svg"],removeStylesFromLitTemplates=e=>{TEMPLATE_TYPES.forEach(t=>{const s=templateCaches.get(getTemplateCacheKey(t,e));void 0!==s&&s.keyString.forEach(e=>{const{element:{content:t}}=e,s=new Set;Array.from(t.querySelectorAll("style")).forEach(e=>{s.add(e)}),removeNodesFromTemplate(e,s)})})},shadyRenderSet=new Set,prepareTemplateStyles=(e,t,s)=>{shadyRenderSet.add(s);const i=e.querySelectorAll("style");if(0===i.length)return void window.ShadyCSS.prepareTemplateStyles(t.element,s);const r=document.createElement("style");for(let e=0;e<i.length;e++){const t=i[e];t.parentNode.removeChild(t),r.textContent+=t.textContent}if(removeStylesFromLitTemplates(s),insertNodeIntoTemplate(t,r,t.element.content.firstChild),window.ShadyCSS.prepareTemplateStyles(t.element,s),window.ShadyCSS.nativeShadow){const s=t.element.content.querySelector("style");e.insertBefore(s.cloneNode(!0),e.firstChild)}else{t.element.content.insertBefore(r,t.element.content.firstChild);const e=new Set;e.add(r),removeNodesFromTemplate(t,e)}},render$1=(e,t,s)=>{const i=s.scopeName,r=parts.has(t),n=t instanceof ShadowRoot&&compatibleShadyCSSVersion&&e instanceof TemplateResult,a=n&&!shadyRenderSet.has(i),o=a?document.createDocumentFragment():t;if(render(e,o,Object.assign({templateFactory:shadyTemplateFactory(i)},s)),a){const e=parts.get(o);parts.delete(o),e.value instanceof TemplateInstance&&prepareTemplateStyles(o,e.value.template,i),removeNodes(t,t.firstChild),t.appendChild(o),parts.set(t,e)}!r&&n&&window.ShadyCSS.styleElement(t.host)};
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
...
(window.litElementVersions||(window.litElementVersions=[])).push("2.0.1");const flattenStyles=e=>e.flat?e.flat(1/0):arrayFlat(e);class LitElement extends UpdatingElement{static finalize(){super.finalize(),this._styles=this.hasOwnProperty(JSCompiler_renameProperty("styles",this))?this._getUniqueStyles():this._styles||[]}static _getUniqueStyles(){const e=this.styles,t=[];if(Array.isArray(e)){flattenStyles(e).reduceRight((e,t)=>(e.add(t),e),new Set).forEach(e=>t.unshift(e))}else e&&t.push(e);return t}initialize(){super.initialize(),this.renderRoot=this.createRenderRoot(),window.ShadowRoot&&this.renderRoot instanceof window.ShadowRoot&&this.adoptStyles()}createRenderRoot(){return this.attachShadow({mode:"open"})}adoptStyles(){const e=this.constructor._styles;0!==e.length&&(void 0===window.ShadyCSS||window.ShadyCSS.nativeShadow?supportsAdoptingStyleSheets?this.renderRoot.adoptedStyleSheets=e.map(e=>e.styleSheet):this._needsShimAdoptedStyleSheets=!0:window.ShadyCSS.ScopingShim.prepareAdoptedCssText(e.map(e=>e.cssText),this.localName))}connectedCallback(){super.connectedCallback(),this.hasUpdated&&void 0!==window.ShadyCSS&&window.ShadyCSS.styleElement(this)}update(e){super.update(e);const t=this.render();t instanceof TemplateResult&&this.constructor.render(t,this.renderRoot,{scopeName:this.localName,eventContext:this}),this._needsShimAdoptedStyleSheets&&(this._needsShimAdoptedStyleSheets=!1,this.constructor._styles.forEach(e=>{const t=document.createElement("style");t.textContent=e.cssText,this.renderRoot.appendChild(t)}))}render(){}}LitElement.finalized=!0,LitElement.render=render$1;class CaptureImage extends LitElement{static get is(){return"capture-image"}static get properties(){return{sizeX:{type:Number},sizeY:{type:Number},maskpercent:{type:Number},mask:{type:Boolean}}}static get styles(){return css`
    ...
    `}constructor(){super(),this.sizeX=640,this.sizeY=480,this.mask=!1,this.maskpercent=30,this.masksizeX=0,this.masksizeY=0}connectedCallback(){super.connectedCallback()}firstUpdated(){this.canvas=this.renderRoot.querySelector("#canvas"),this.context=this.canvas.getContext("2d"),this.video=this.renderRoot.querySelector("#video"),this.saveBtn=this.renderRoot.querySelector("#save"),this.mask&&this.addMask(),this.canvas.width=640-2*this.masksizeX,this.canvas.height=480-2*this.masksizeY,this.mirror=this.renderRoot.querySelector("#mirror"),this.main()}addMask(){this.mask=this.renderRoot.querySelector("#mask"),this.maskCtx=this.mask.getContext("2d"),this.masksizeX=this.sizeX*this.maskpercent/200,this.masksizeY=this.sizeY*this.maskpercent/200,this.maskCtx.fillStyle="rgba(0, 0, 0, 0.5)",this.maskCtx.fillRect(0,0,this.sizeX,this.masksizeY),this.maskCtx.fillRect(0,this.sizeY-this.masksizeY,this.sizeX,this.masksizeY),this.maskCtx.fillRect(0,this.masksizeY,this.masksizeX,this.sizeY-2*this.masksizeY),this.maskCtx.fillRect(this.sizeX-this.masksizeX,this.masksizeY,this.masksizeX,this.sizeY-2*this.masksizeY)}main(){navigator.mediaDevices&&navigator.mediaDevices.getUserMedia&&navigator.mediaDevices.getUserMedia({video:!0}).then(e=>{this.video.srcObject=e,this.video.play()})}snapImage(){let e=this.video;this.context.drawImage(e,640*this.maskpercent/200,480*this.maskpercent/200,640-640*this.maskpercent/200*2,480-480*this.maskpercent/200*2,0,0,640-640*this.maskpercent/200*2,480-480*this.maskpercent/200*2),this.saveBtn.style.visibility="visible"}saveImage(){let e=this.canvas.toDataURL("image/png"),t=new Date,s=""+t.getYear()+t.getMonth()+t.getDate()+t.getHours()+t.getMinutes()+t.getSeconds();this.saveBtn.download="snap"+s,this.saveBtn.href=e}render(){return html`
      <style>
        #mask {
          width:${this.sizeX}px;
